...
// 修改email
router.patch('/profile/email', authenticated, formRules.updateEmail, validationHandler, userController.updateEmail)
// 修改姓名
router.patch('/profile/name', authenticated, formRules.updateName, validationHandler, userController.updateName)
